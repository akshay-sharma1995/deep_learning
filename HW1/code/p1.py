...
class MLP(object):
    ...
    def load_model(self, path='p1_model.npz'):
...
def test_model(mlp,dset,batch_size):
    train, val, test = dset
    testx, testy = test
    test_loss = 0
    test_error = 0
...
def parse_args():
    ...
    parser.add_argument('--model-path', dest='model_path', type=str, default="./p1_model.npz", help="saved model path")
